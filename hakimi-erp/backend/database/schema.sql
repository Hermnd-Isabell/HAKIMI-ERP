...
CREATE TABLE `delivery` (
  ...
  `carrier` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Carrier',
...
CREATE TABLE `invoice` (
  ...
  `sales_org` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '销售组织代码',
  `distribution_channel` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '分销渠道代码',
  `division` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '产品组/事业部代码',
  `shipping_point` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '装运点/发货点',
  `sold_to_party` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payer` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `destination_country` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '货物目的国家',
  `currency` char(3) COLLATE utf8mb4_unicode_ci DEFAULT 'CNY',
  `total_amount` decimal(15,2) DEFAULT NULL,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'OPEN' COMMENT 'OPEN/PARTIAL/CLEARED/VOID',
  `remark` text COLLATE utf8mb4_unicode_ci COMMENT '其他补充说明',
  `search_term` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '辅助检索用关键词',
...
CREATE TABLE `invoice_item` (
  ...
  `sales_unit` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '销售计量单位',
  `unit_price` decimal(15,2) DEFAULT NULL,
  `discount` decimal(5,2) DEFAULT NULL COMMENT '折扣百分比或金额',
  `tax_amount` decimal(15,2) DEFAULT NULL,
  `net_price` decimal(15,2) DEFAULT NULL,
  `item_description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '行项目补充说明',
  `remark` text COLLATE utf8mb4_unicode_ci COMMENT '其他补充说明',
