        ...
        <table class="data-table">
          ...
          <tbody>
            <tr v-for="r in rows" :key="r.id" class="data-row">
              ...
              <td><a class="link" @click="$router.push('/sales/quotation')">View Details</a></td>
            </tr>
          </tbody>
        </table>
...
interface R{id:number;no:string;cust:string;date:string;val:string;st:string}
const rows:R[]=[
  {id:1,no:'SO000120',cust:'The Bike Zone',date:'2026-01-15',val:'$85,000.00',st:'Completed'},
  {id:2,no:'SO000121',cust:'Acme Corp',date:'2026-02-20',val:'$142,500.00',st:'In Process'},
  {id:3,no:'SO000122',cust:'GlobalTech',date:'2026-03-10',val:'$210,000.00',st:'Open'},
  {id:4,no:'SO000123',cust:'Beta Industries',date:'2026-04-05',val:'$56,200.00',st:'Cancelled'},
  {id:5,no:'SO000124',cust:'Delta Supply',date:'2026-05-18',val:'$78,900.00',st:'Completed'},
]
function sc(s:string){const m:Record<string,string>={'Open':'s-open','In Process':'s-proc','Completed':'s-done','Cancelled':'s-cancel'};return m[s]||''}
</script>
