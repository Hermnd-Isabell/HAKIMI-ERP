...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/sales/inquiry", name: "Inquiry", component: () => import("@/views/sales/InquiryManagement.vue"), meta: { title: "Inquiry Management" } },
    { path: "/sales/quotation", name: "QuotationItem", component: () => import("@/views/sales/QuotationItem.vue"), meta: { title: "Create Quotation: Item Data" } },
